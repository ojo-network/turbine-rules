# ETH 15-Minute Quick Market Resolution Rules

## Market Question Format

**"Will ETH be higher than ${STRIKE_PRICE} at {END_TIME} UTC?"**

Markets are created every 15 minutes. Each market has a fixed strike price and expiration time.

## Resolution Criteria

- **YES** wins if the ETH/USD price is **strictly higher** than the strike price at the market's expiration time (`end_time`).
- **NO** wins if the ETH/USD price is **equal to or lower** than the strike price at expiration.
...
### Primary Source
**Pyth Network ETH/USD Price Feed**
- Feed ID: ETH/USD on Pyth mainnet
...
1. Use Pyth Network ETH/USD price at `end_time`
