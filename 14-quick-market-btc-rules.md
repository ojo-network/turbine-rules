# BTC 15-Minute Quick Market Resolution Rules

## Market Question Format

**"Will BTC be higher than ${STRIKE_PRICE} at {END_TIME} UTC?"**

Markets are created every 15 minutes. Each market has a fixed strike price and expiration time.

## Resolution Criteria

- **YES** wins if the BTC/USD price is **strictly higher** than the strike price at the market's expiration time (`end_time`).
- **NO** wins if the BTC/USD price is **equal to or lower** than the strike price at expiration.
...
### Primary Source
**Pyth Network BTC/USD Price Feed**
- Feed ID: BTC/USD on Pyth mainnet
...
1. Use Pyth Network BTC/USD price at `end_time`
